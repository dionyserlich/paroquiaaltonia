      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded-md bg-parish-card/60 border border-white/25 px-3 py-2 text-white outline-none focus:border-yellow-500"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-2">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-yellow-500 text-parish-card font-semibold px-5 py-2.5 rounded-md hover:bg-yellow-400 transition disabled:opacity-60 disabled:cursor-not-allowed"
          >
