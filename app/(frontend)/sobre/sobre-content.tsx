    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-parish-card to-parish-card-end p-6 rounded-lg border border-yellow-500">
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-lg">
                ...
                <div className="absolute top-2 left-2">
                  <span className="bg-yellow-500 text-parish-card px-2 py-1 rounded-full text-xs font-semibold">
                    Anos 1970-1980
                  </span>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-parish-card to-parish-card-end p-6 rounded-lg border border-yellow-500">
            <div className="space-y-4">
              <div className="relative overflow-hidden rounded-lg">
                ...
                />
                <div className="absolute top-2 left-2">
                  <span className="bg-green-400 text-parish-card px-2 py-1 rounded-full text-xs font-semibold">
                    Atual
                  </span>
                </div>
              </div>
      ...
      <div className="space-y-6">
        {timeline.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={`bg-gradient-to-r from-parish-card to-parish-card-end p-6 rounded-lg border-l-4 ${style.cor}`}
            >
              <div className="flex items-start space-x-4">
                <div className={`${style.bgIcone} p-2 rounded-full flex-shrink-0`}>
                  <Icon className="w-5 h-5 text-parish-card" />
                </div>
                <div>
                  <div className="flex items-center space-x-2 mb-3">
                    <h2 className="text-xl font-bold text-white">{item.titulo}</h2>
                    <span className={`${style.bgIcone} text-parish-card px-2 py-1 rounded-full text-xs font-semibold`}>
                      {item.badge}
                    </span>
                  </div>
      ...
      {legado && (
        <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 p-6 rounded-lg text-parish-card">
          <div className="flex items-start space-x-4">
            <div className="bg-parish-card p-2 rounded-full flex-shrink-0">
      ...
      {/* Call to Action */}
      <div className="text-center bg-gradient-to-r from-parish-card to-parish-card-end p-6 rounded-lg border border-yellow-500">
        ...
        <div className="flex justify-center space-x-4">
          <a
            href="/horarios"
            className="bg-yellow-500 text-parish-card px-4 py-2 rounded-lg font-semibold hover:bg-yellow-400 transition-colors"
          >
            Ver Horários
          </a>
          <a
