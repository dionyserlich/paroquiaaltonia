...
export async function PUT(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    await updateFile("data/proximosEventos.json", eventos, sha, `Atualizar evento: ${data.titulo}`, config)
...
export async function DELETE(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    // Atualizar arquivo no GitHub
    await updateFile("data/proximosEventos.json", novosEventos, sha, `Excluir evento: ${evento.titulo}`, config)
