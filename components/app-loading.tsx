  ...
  return (
    <div className="fixed inset-0 bg-[#00143d] flex flex-col items-center justify-center z-50">
      <div className="relative">
        ...
        <div className="spinner-border absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 border-4 border-yellow-500/20 border-t-yellow-500 rounded-full"></div>
      </div>
